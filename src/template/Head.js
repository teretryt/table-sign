        ...
        <nav aria-label="Global" className="flex items-center justify-between p-6 lg:px-8">
          <div className="flex lg:flex-1">
            <NavLink to="/" className="-m-1.5 p-1.5">
              <span className="sr-only">TabelaSign</span>
              <img
                alt=""
          ...
          <div className="hidden lg:flex lg:flex-1 lg:justify-end gap-3 items-center">
            <NavLink to="/cart" className={`flex gap-2 p-2 rounded-full text-sm font-semibold leading-6 ${isWhite ? 'text-white border-2 border-red-100' : 'text-gray-900 bg-red-100'}`}>
          ...
          <DialogPanel className="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
            <div className="flex items-center justify-between">
              <a href="#" className="-m-1.5 p-1.5">
                <span className="sr-only">Tabela Sign</span>
                <img
                  alt=""
                  src="textures/logo.png"
                  className="h-12 w-auto"
